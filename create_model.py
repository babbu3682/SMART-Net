...
class Patient_Cls_model(torch.nn.Module):
    def __init__(self, end2end=False, backbone_name='resnet50'):
        ...
        if backbone_name == 'resnet50':
            ...
            self.LSTM    = nn.LSTM(input_size=640, hidden_size=512, num_layers=2, batch_first=True, bidirectional=True)

        self.linear1 = nn.Linear(512*2, 512, True)
        self.relu1   = nn.ReLU(True)
        self.drop1   = nn.Dropout(p=0.5)
        # Head
        self.fc      = nn.Linear(512, 1, True)       
