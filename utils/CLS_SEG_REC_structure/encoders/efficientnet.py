...
class EfficientNetEncoder(EfficientNet, EncoderMixin):
    ...
    def get_stages(self):
        return [
            ...
            self._blocks[:self._stage_idxs[0]],                          # nonlocal
            self._blocks[self._stage_idxs[0]:self._stage_idxs[1]],       # nonlocal
            self._blocks[self._stage_idxs[1]:self._stage_idxs[2]],       # nonlocal   (11, 18, 38, 55),
